...
export class LayoutBasicComponent {
  ...
  constructor(private settings: SettingsService, private cdr: ChangeDetectorRef, private elementRef: ElementRef<HTMLElement>) {
    //#region 重写reuseTab行为
  ...
  ngAfterViewInit(): void {
     ...
     */
    let selectHeader = this.elementRef.nativeElement.querySelector("#header");
    if (selectHeader) {
