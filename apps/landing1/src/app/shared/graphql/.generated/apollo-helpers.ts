...
export type ChatKeySpecifier = ('userId' | 'sessionToken' | 'aiPersonality' | 'messages' | 'modifiedOn' | 'id' | 'createdOn' | ChatKeySpecifier)[];
export type ChatFieldPolicy = {
	userId?: FieldPolicy<any> | FieldReadFunction<any>,
	sessionToken?: FieldPolicy<any> | FieldReadFunction<any>,
	aiPersonality?: FieldPolicy<any> | FieldReadFunction<any>,
	messages?: FieldPolicy<any> | FieldReadFunction<any>,
	modifiedOn?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	createdOn?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ChatMessageKeySpecifier = ('chatId' | 'content' | 'isHidden' | 'chatMessageType' | 'chat' | 'voice' | 'modifiedOn' | 'id' | 'createdOn' | ChatMessageKeySpecifier)[];
export type ChatMessageFieldPolicy = {
	...
	chatMessageType?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type MutationFieldPolicy = {
	...
	editChat?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type QueryKeySpecifier = ('_' | 'tenants' | 'users' | 'currentUser' | 'orgs' | 'roles' | 'messages' | 'unreadMessages' | 'blobObjects' | 'settings' | 'initSettings' | 'myPermissions' | 'orders' | 'orderById' | '_hint' | 'orgsCache' | 'quotas' | 'quotaById' | 'chats' | 'chatById' | 'templateUpdateDate' | QueryKeySpecifier)[];
...
export type SubscriptionKeySpecifier = ('_' | 'onFrontendCall' | 'onBroadcast' | 'echo' | 'onCacheDataChange' | 'onNewMessage' | SubscriptionKeySpecifier)[];
