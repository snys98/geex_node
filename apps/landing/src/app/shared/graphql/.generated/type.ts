...
export interface ChatMessage extends IEntityBase {
  ...
  chat: Chat;
  voice?: Maybe<Array<Scalars['Byte']>>;
  modifiedOn: Scalars['DateTime'];
  id: Scalars['String'];
  createdOn: Scalars['DateTime'];
}
...
export interface MutationEditChatArgs {
  id: Scalars['String'];
  input: EditChatInput;
}
...
export interface MutationSendChatMessageArgs {
  chatId: Scalars['String'];
  messageText: Scalars['String'];
  messageVoiceBase64?: Maybe<Scalars['String']>;
}
...
export type GenerateTemplateMutation = (
  { __typename?: 'Mutation' }
  & { generateTemplate: (
    { __typename?: 'BlobObject' }
    & Pick<BlobObject, 'fileName' | 'md5' | 'fileSize' | 'mimeType' | 'storageType' | 'url'>
  ) }
);
...
export const GenerateTemplateGql = gql`
    mutation generateTemplate($template: Template!, $args: TemplateArgsInput!) {
  generateTemplate(template: $template, args: $args) {
    fileName
    md5
    fileSize
    mimeType
    ...
    ` as unknown as DocumentNode<GenerateTemplateMutation, GenerateTemplateMutationVariables>;
