...
import { FormGroupExtend } from "./directives/form-group-extend.directive";
...
@NgModule({
  imports: [
    ...
    DelonAuthModule,
    DelonFormModule,
    NgxsModule.forFeature([CacheDataState, UserDataState, TenantState, ChatState]),
    // NgxTinymceModule,
