...
import { CacheDataState, CacheDataStateModel } from "../states/cache-data.state";
...
export abstract class BusinessComponentBase<TParam = any, TDto = any> {
  ...
  constructor(injector: Injector) {
    ...
    this.routerOutlet = injector.get(RouterOutlet, null, { optional: true });
    ...
    this.tokenSrv = injector.get<TokenService>(DA_SERVICE_TOKEN);
  }
  log(x: any) {
    //console.log(x);
    return x;
