...
export type OrderKeySpecifier = ('name' | 'modifiedOn' | 'id' | 'createdOn' | OrderKeySpecifier)[];
...
export type QueryKeySpecifier = ('_' | 'tenants' | 'users' | 'currentUser' | 'orgs' | 'roles' | 'messages' | 'unreadMessages' | 'blobObjects' | 'settings' | 'initSettings' | 'myPermissions' | 'orders' | 'orderById' | '_hint' | 'orgsCache' | QueryKeySpecifier)[];
