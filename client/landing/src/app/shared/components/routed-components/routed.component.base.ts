...
import { AbstractControl, FormBuilder, FormControl, FormGroup, TypedFormGroup } from "@angular/forms";
...
export abstract class RoutedComponent<TParams extends {}, TContext> extends BusinessComponentBase {
  ...
  async prepare(resolvedParams: TParams) {
    ...
    this.params = this.fb.group(Object.fromEntries(group)) as TypedFormGroup<TParams>;
  }
  //刷新
  refresh() {
